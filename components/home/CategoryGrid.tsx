        ...
        {categories.map((cat, i) => {
          ...
          return (
            ...
            >
              ...
              {/* Label */}
              <span className="text-[11px] sm:text-xs font-bold text-gray-600 text-center leading-tight
                group-hover:text-blue-600 transition-colors duration-200 max-w-[72px]">
                {cat.name}
              </span>
            </Link>
          );
