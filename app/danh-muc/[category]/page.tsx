      ...
      <div className="max-w-7xl mx-auto px-4 py-4 sm:py-6">
        ...
        <div className="bg-gradient-to-r from-[#0055b3] to-[#0077e6] rounded-2xl p-6 sm:p-8 mb-7 text-white shadow-lg">
          <div className="flex items-center gap-5">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/15 backdrop-blur rounded-2xl flex items-center justify-center text-4xl sm:text-5xl flex-shrink-0">
              {cat.icon}
            </div>
            <div>
        ...
        {catProducts.length === 0 ? (
          ...
          <>
            <p className="text-sm font-semibold text-gray-500 mb-4">
              Hiển thị <strong className="text-gray-800">{catProducts.length}</strong> sản phẩm
            </p>
